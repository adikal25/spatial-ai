...
st.markdown(
    ...
    <div style="text-align: center; color: #666;">
        Built with Claude Sonnet 4, FastAPI, MiDaS Depth Estimation, and Streamlit
    </div>
    """,
